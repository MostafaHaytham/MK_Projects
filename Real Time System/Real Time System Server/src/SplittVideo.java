 ...
 */
public class SplittVideo {
 public static final double SECONDS_BETWEEN_FRAMES = 0.1;    
    public static String path = "/Users/Haytham/Desktop/mysnapshot/";
    public static final String inputFilename = path + "test2.mp4";
    private static final String outputFilePrefix = path;
