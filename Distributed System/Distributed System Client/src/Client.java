...
public class Client {
    ...
    public static void main(String[] args)  {
        ...
        try {
            ...
            Manager summer = (Manager) registry.lookup("Summer");
                ...
                if (choice == 1) {//Create Account
                    ...
                    if (checklogin) {
                        ...
                        if (choice == 1) {//create event
                            ...
                            } else if (choice == 2) {// view specific
                    ...
                    } else {//have to login to edit
                        System.out.println("You have to login first!");
                        System.out.println();
                    }

                }  else if (choice == 4) {//Search
                System.out.println("How you wanna know the data? (1.day/2.hour)");
                choice = s.nextInt();
                if (choice == 1) {
